...
// its position on screen. It will provide methods for updating
// and destroying the enemy also.
class Bonus {
  ...
  constructor(theRoot, bonusSpot) {
    ...
    this.domElement.src = "./images/ketchup.png";
  ...
  update(timeDiff) {
    ...
    if (this.y > GAME_HEIGHT) {
      ...
      this.destroyed = true;
      // create a counter for each enemy that becomes destroyed which determines score
    }
  }
}
